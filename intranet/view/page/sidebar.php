...
<div class=" row col-md-1 float-left col-1 pl-0 pr-0 collapse width show  shadow  border-right" id="sidebar" > 
            <div class="list-group border-0 text-center text-md-left" >
                ...
                <div class="collapse" id="menu1" data-parent="#sidebar">
                    <a href="#menu1sub1" class="list-group-item" data-toggle="collapse" aria-expanded="false">Usuarios</a>
                    <div class="collapse" id="menu1sub1" data-parent="#menu1">
                        <a href="?controller=usuarios&action=crear" class="list-group-item" data-parent="#menu1sub1">Crear</a>
                        <a href="?controller=usuarios&action=inicio" class="list-group-item" data-parent="#menu1sub1">Mostrar</a>
                        <a href="#" class="list-group-item" data-parent="#menu1sub1">Generar Excel</a>
                    </div>
